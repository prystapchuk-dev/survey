<template>
  <fieldset class="mb-4">
    <div>
      <legend class="text-base font-medium to-gray-900">
      ...
      <div v-else-if="question.type === 'radio'">
        <div v-for="(option, ind) of question.data.options"
          ...
          <input
            ...
            @change="emits('update:modelValue', $event.target.value)"
            :id="option.uuid"
            class="focus:ring-indigo-500 h-4 w-4 to-indigo-600 border-gray-300"
          />
          <label
            :for="option.uuid"
      ...
      <div v-else-if="question.type === 'checkbox'">
        ...
        <div v-for="(option, ind) of question.data.options"
          ...
          <input
            ...
            :id="option.uuid"
            class="focus:ring-indigo-500 h-4 w-4 to-indigo-600 border-gray-300 rounded"
          />
          <label
            :for="option.uuid"
            class="ml-3 block text-sm font-medium text-gray-700"
